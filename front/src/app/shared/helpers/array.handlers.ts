 ...
 * @param to
 */
export function arrayReorder(array, from, to) {
...
/**
 * Convert an array or timestamp or string or object to a Date object
 * @param d
 * @returns {Date | number}
 */
...
/**
 * Check if a given date is within a range of dates
 * @param d
 * @param start
 * @param end
